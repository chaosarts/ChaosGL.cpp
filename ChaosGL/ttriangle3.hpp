...
#ifndef ChaosGL_ttriangle3_hpp
#define ChaosGL_ttriangle3_hpp
...
namespace chaosgl
{
	...
	public:
		 ...
		 */
		ttriangle3 (VectorType a, VectorType b, VectorType c) : a(a), b(b), c(c)
		{
			if (glm::dot(u(), v()) == 0.0)
		 ...
		 */
		ttriangle3 (const Self &t) : a(t.a), b(t.b), c(t.c) {}
