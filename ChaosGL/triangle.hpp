...
namespace chaosgl
{
	...
	typedef ttriangle3<float, glm::defaultp> float_triangle3;
	...
	typedef float_triangle3 triangle3;
	...
	typedef ttriangle2<float, glm::defaultp> float_triangle2;
	...
	typedef float_triangle2 triangle2;
}
